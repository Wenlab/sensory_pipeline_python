...
def prepare_signal_dict(h5_file_path, root_name, labjack_excel_path):
...
def prepare_single_signal_plotly(h5_file_path, root_name, labjack_excel_path, id_excel_path=None, color_scheme=None, stim_name=None):
    signal_dict, stimulus_intervals, stimulus_list = prepare_signal_dict(h5_file_path, root_name, labjack_excel_path)
...
def create_plotly_fig(h5_file_path, root_name, labjack_excel_path, id_excel_path=None, cluster=False, color_scheme=None, stim_name=None, **kwargs):
    signal_dict, stimulus_intervals, stimulus_name_list, color_list, id_name_dict = prepare_single_signal_plotly(h5_file_path, root_name, labjack_excel_path, id_excel_path, color_scheme, stim_name)
    if cluster:
    ...
    add_regions_to_fig(
        ...
        stimulus_name_list,
        color=color_list,
        alpha=kwargs.pop('region_alpha', 0.3),
        showlegend=kwargs.pop('show_region_legend', True),
    )
